...
//bool is_equal(char a, char b)                    { return a == b; }
//bool is_equal(short a, short b)                  { return a == b; }
//bool is_equal(long a, long b)                    { return a == b; }
//bool is_equal(long long a, long long b)          { return a == b; }
//bool is_equal(unsigned char a, unsigned char b)  { return a == b; }
//bool is_equal(unsigned short a, unsigned short b){ return a == b; }
//bool is_equal(unsigned int a, unsigned int b)    { return a == b; }
//bool is_equal(unsigned long a, unsigned long b)  { return a == b; }
//bool is_equal(unsigned long long a, unsigned long long b) { return a == b; }
...
std::string str(char a)           { return std::to_string(a); }
