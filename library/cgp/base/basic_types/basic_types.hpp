...
// Uniform equality test function is_equal() for all type
...
//bool is_equal(short a, short b);
//bool is_equal(long a, long b);
//bool is_equal(long long a, long long b);
//bool is_equal(unsigned char a,unsigned char b);
//bool is_equal(unsigned short a, unsigned short b);
//bool is_equal(unsigned int a, unsigned int b);
//bool is_equal(unsigned long a, unsigned long b);
//bool is_equal(unsigned long long a, unsigned long long b);
// mixed equality
