...
namespace cgp
{
	...
	{
		// Setup shader
		assert_cgp(drawable.shader!=0, "Try to draw mesh_wireframe_drawable without shader");
		...
		// Call draw function
		assert_cgp(drawable.number_normals>0, "Try to draw mesh_wireframe_drawable with 0 edges"); opengl_check;
