...
namespace cgp
{
	...
	*/
	GLFWwindow* create_window(int width=800, int height=600, std::string const& window_title="cgp Display", int opengl_version_major = 3, int opengl_version_minor = 3, GLFWmonitor* monitor=nullptr, GLFWwindow* share=nullptr);
