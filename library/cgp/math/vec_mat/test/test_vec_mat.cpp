...
namespace cgp_test
{
	void test_vec_mat()
	{
		...
		//det and inverse mat2
		{
			...
			assert_cgp_no_msg( is_equal(inverse(a)*a, mat2::identity()) );
		}
		...
		//det and inverse mat3
		{
			...
			assert_cgp_no_msg( is_equal(inverse(a)*a, mat3::identity()) );
		}
		...
		//det and inverse mat4
		{
			...
			assert_cgp_no_msg( norm(inverse(a)*a - mat4::identity())<1e-2f );
		}
