...
namespace cgp
{
	...
	*/
	struct rotation_transform
	{
		...
		static rotation_transform between_vector(vec3 const& e0, vec3 const& e_target);
		...
		static rotation_transform between_vector(vec3 const& e1, vec3 const& e2, vec3 const& e1_target, vec3 const& e2_target);
