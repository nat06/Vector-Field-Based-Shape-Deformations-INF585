...
struct constant_velocity_structure {//might want to change the name
	constant_velocity_direction type = direction_normal;      // Type of deformation type
...
void update_velocity_field(cgp::grid_3D<cgp::vec3>& velocity, cgp::grid_3D<cgp::vec3> const& grid, sphere_tool_structure const& sphere_tool, cgp::vec3 const& previous_tool_pos, cgp::vec3 const& tr, cgp::vec3& constant_vel, cgp::vec3 const& picked_normal, constant_velocity_structure const& constant_velocity);

//void update_velocity_field(cgp::grid_3D<cgp::vec3>& velocity, cgp::grid_3D<cgp::vec3> const& grid, sphere_tool_structure const& sphere_tool, cgp::vec3 const& previous_tool_pos, cgp::vec3 const& tr);
